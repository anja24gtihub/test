...
export class SortingComponent implements OnInit {
  ...
  generateArrayOfPowers() {
    ...
    const sizeOfArray = 5;
    const i = 0;
    this.arrayOfPowers = new Array();

    this.arrayOfPowers = Array.apply(null, Array(sizeOfArray)).map(function () {
  ...
  generateRandomArray() {
    ...
    this.randomArray = Array.apply(null, Array(length)).map(function () {
